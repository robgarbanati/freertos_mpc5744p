...
#elif (TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_NXP_MPC57)
...
#include "device_registers.h"
 ...
 #define PIT PIT_0
    ...
    #define TRC_HWTC_TYPE TRC_OS_TIMER_DECR
    #define TRC_HWTC_COUNT *((uint32_t *)PIT->TIMER[configUSE_PIT_CHANNEL].CVAL )
    #define TRC_HWTC_PERIOD *((uint32_t *)PIT->TIMER[configUSE_PIT_CHANNEL].LDVAL )
    #define TRC_HWTC_DIVISOR 1
    #define TRC_HWTC_FREQ_HZ (TRACE_TICK_RATE_HZ * TRC_HWTC_PERIOD)
    #define TRC_IRQ_PRIORITY_ORDER 0
